  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col md:flex-row">
      ...
      `}>
        ...
        <p className="px-6 text-xs text-text-muted mt-2 font-medium md:block hidden">Patient Portal</p>
        ...
        <nav className="flex-1 p-4 space-y-1">
          ...
          <SidebarItem 
            ...
            onClick={() => { setActiveTab('find-doctors'); setIsMobileMenuOpen(false); }} 
          />
          <SidebarItem 
      ...
      <main className="flex-1 md:ml-64 p-4 md:p-8 w-full">
        <header className="flex justify-between items-center mb-6 md:mb-8">
          <div>
            ...
            <p className="text-sm md:text-base text-text-muted">Welcome back, Patient</p>
          </div>
